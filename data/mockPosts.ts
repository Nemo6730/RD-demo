...
const baseMockPosts: MockPost[] = [
  ...
  {
    id: "post_study_04",
    title: "周末做藤编托盘：第一次做就踩坑，但成品还挺治愈",
    content:
      "我用的是 3mm 藤条和木工白胶，原本想两小时搞定，结果绕角的时候一直开裂。后来把藤条先泡水 20 分钟，再慢慢压弯，成功率高很多。这个手工不算省时，但做完放在玄关装钥匙真的很有成就感。适合周末慢慢做，不适合赶进度的时候硬上。",
    authorName: "木木",
    authorAvatar: "/images/mock/avatar-lifestyle-01.jpg",
    coverImage: "/images/mock/lifestyle-01.jpg",
    tags: ["藤编托盘", "手工DIY", "玄关收纳", "周末慢生活"],
    likeCount: 553,
    collectCount: 889,
    commentCount: 3,
    comments: makeComments("post_study_04", [
      ["阿笙", "泡水这步太关键了，我之前一直裂。", 11],
      ["Kiki", "你托盘边缘用的是白胶还是热熔胶？", 8],
      ["Tom", "看起来好适合放在玄关，想抄作业。", 5],
    ]),
    isHearted: true,
  ...
  {
    id: "post_study_05",
    title: "旧柜门翻新实测：砂纸和木蜡油顺序别搞反",
    content:
      "家里阳台小柜子本来掉漆很严重，我这次先用 240 号砂纸打磨，再上两层浅胡桃木蜡油，颜色比想象中自然。第一次我急着上第二层，结果表面发黏，后来延长到 8 小时再叠涂就正常了。翻新成本不高，但需要耐心晾干，适合周末慢改家。",
    authorName: "安琪",
    authorAvatar: "/images/mock/avatar-lifestyle-02.jpg",
    coverImage: "/images/mock/lifestyle-02.jpg",
    tags: ["柜门翻新", "木蜡油", "家装改造", "低成本焕新"],
    likeCount: 477,
    collectCount: 780,
    commentCount: 3,
    comments: makeComments("post_study_05", [
      ["Amy", "木蜡油间隔 8 小时这个提醒太有用了。", 9],
      ["Ray", "你是刷子上油还是棉布擦？", 6],
      ["J", "旧柜子翻新后真的像换了新家具。", 8],
    ]),
    isHearted: true,
  ...
  {
    id: "post_study_06",
    title: "厨房小推车改造：IKEA 基础款也能做出顺手动线",
    content:
      "我把 IKEA 小推车上层改成咖啡区，中层放常用调料，下层收纳保鲜盒，做饭时来回走动明显少了。踩坑点是轮子太顺，推的时候会漂，我后面给两侧加了防滑垫就稳很多。这个改造不贵，但很看摆放习惯，建议先用纸笔画一下动线再开做。",
    authorName: "小羽",
    authorAvatar: "/images/mock/avatar-lifestyle-03.jpg",
    coverImage: "/images/mock/lifestyle-03.jpg",
    tags: ["IKEA小推车", "厨房收纳", "家装动线", "手工改造"],
    likeCount: 512,
    collectCount: 834,
    commentCount: 3,
    comments: makeComments("post_study_06", [
      ["Iris", "先画动线这个步骤太专业了，我每次都乱放。", 10],
      ["木木", "轮子会漂这个痛点我家也有。", 7],
      ["Noah", "这种改造看着简单但真的提升日常效率。", 6],
    ]),
    isHearted: true,
  ...
  {
    id: "post_study_07",
    title: "手作灯罩小改：亚麻布换掉后客厅质感提升很多",
    content:
      "我把原本偏冷白的塑料灯罩换成亚麻布灯罩，晚上开灯后整体更柔和，客厅看起来没那么“办公室感”。第一次胶水涂太多有渗痕，第二次改成薄涂 + 夹子固定，边缘就平整了。这个改造不复杂，但要等干透再装回去，不然容易歪。",
    authorName: "悠悠",
    authorAvatar: "/images/mock/avatar-lifestyle-04.jpg",
    coverImage: "/images/mock/lifestyle-04.jpg",
    tags: ["灯罩改造", "亚麻布手作", "客厅氛围", "家装细节"],
    likeCount: 436,
    collectCount: 702,
    commentCount: 3,
    comments: makeComments("post_study_07", [
      ["Lio", "亚麻灯罩的光感真的会温柔很多。", 8],
      ["KK", "你用的是热熔胶还是白乳胶？", 5],
      ["Mita", "薄涂+夹子这个技巧记下了。", 6],
    ]),
    isHearted: true,
